...
public final class ActivityAdminPanelBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton fabAddDesk;
  ...
  private ActivityAdminPanelBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull FloatingActionButton fabAddDesk,
      @NonNull TabLayout tabLayout, @NonNull Toolbar toolbar, @NonNull ViewPager2 viewPager) {
    this.rootView = rootView;
    this.appBarLayout = appBarLayout;
    this.fabAddDesk = fabAddDesk;
  ...
  public static ActivityAdminPanelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fab_add_desk;
      FloatingActionButton fabAddDesk = ViewBindings.findChildViewById(rootView, id);
      if (fabAddDesk == null) {
        break missingId;
      }
      ...
      return new ActivityAdminPanelBinding((CoordinatorLayout) rootView, appBarLayout, fabAddDesk,
